...
const TV = () => {
    ...
    https://api.themoviedb.org/3/discover/tv?api_key=080f1b1cb9978ae08b86c1ca6a48ed74&language=es-AR&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${genreURL}`);
